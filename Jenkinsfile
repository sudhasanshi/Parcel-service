    ...
    stages {
        stage('checkout') {
            steps {
                ...
                sh 'git clone https://github.com/sudhasanshi/Parcel-service.git'
            }
        }
        ...
        stage('deploy') {
            steps {
                ...
                sh "scp /home/king/workspace/Parcel-service/target/simple-parcel-service-app-1.0-SNAPSHOT.jar root@172.31.3.184:/opt/apache-tomcat-8.5.98/webapps/"
            }
        }
